...
class SelectMachineFrame(tk.Frame):
    ...
    def __init__(self, parent, controller, **kwargs):
        ...
        self.dryer_button = tk.Button(self, text="Dryer", compound="top", width=button_width, height=button_height, image=dryer_icon, font=button_font, command=lambda: [SerialCommand.send("run_dryer:60"), controller.show_frame(StartPage)])
